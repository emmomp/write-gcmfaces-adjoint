function [dimOut]=mywrite2nctiles(fileOut,fldIn,doCreate,varargin)
% WRITE2NCTILES writes a gcmfaces object to nctiles, tiled netcdf, files
% Edited 2018 by E Boland from original gcmfaces version
%
% inputs : 
...
coord=''; dimsize=[]; xtype='double'; descr=''; rdm=''; dimlist={};
dimName={};
